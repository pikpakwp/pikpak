<template>
  <div class="list-page">
    <n-alert title="感谢@andysea" type="info" closable>
      <n-space>
        <a href="https://t.me/Yuncloud" target="_blank">作者</a>
        <a href="https://pikpakwp.github.io/pikpak/"  target="_blank">地址</a>
      </n-space>
    </n-alert>
    <br />
    <n-alert title="请先设置默认上传目录" type="error" v-if="!uploadFolder || !uploadFolder.id">
      请先在文件列表操作选择设置默认 <a href="https://pikpakwp.github.io/pikpak/" target="_blank"> <n-icon style="vertical-align: middle;" size="20" color="#d03050"><zoom-question></zoom-question></n-icon> </a>
    </n-alert>
